...
namespace VidiMetrics.Application.Services.Core
{
    public class ChannelsService : IChannelsService
    {
        ...
        public async Task<ChannelResponseDto> GetByIdAsync(Guid id)
        {
        ...
        public async Task<ChannelResponseDto> CreateAsync(CreateChannelDto dto)
        {
        ...
        public async Task<ChannelResponseDto> UpdateAsync(Guid id, UpdateChannelDto dto)
        {
