export default function CreateSeriesCard() {
    return (
        <button className="h-full w-full border-[1.5px] border-dashed border-white/10 rounded-[2.5rem] bg-white/[0.02] hover:bg-white/[0.04] hover:border-accent-purple/40 transition-all duration-500 group flex flex-col items-center justify-center p-12 text-center">
