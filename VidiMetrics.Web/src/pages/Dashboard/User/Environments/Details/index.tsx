...
import EnvironmentInfoTab from './components/EnvironmentInfoTab'
        ...
        <div className="space-y-10 pb-20">
            ...
            <div className="flex justify-between items-center bg-white/[0.02] border border-white/5 rounded-3xl px-8 py-4">
                <div className="flex items-center gap-8">
                    <button className="text-sm font-bold text-emerald-400 border-b-2 border-emerald-400 pb-1">Environment Workspace</button>
                ...
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`text-[10px] font-black uppercase tracking-[0.2em] pb-4 transition-all duration-300 ${activeTab === tab
                            ? 'text-emerald-400 border-b-2 border-emerald-400 mb-[6px]'
