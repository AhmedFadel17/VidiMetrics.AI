...
import { useGetCharactersByShowQuery } from "@/store/apis";
...
export default function CharactersTab({ showId, initialData }: CharactersTabProps) {
    const { data: response, isLoading, error } = useGetCharactersByShowQuery(showId);
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <button className="glass-card px-6 py-2 rounded-full flex items-center gap-2 hover:bg-white/10">
                    ...
                    <span className="text-xs font-bold text-white uppercase tracking-widest">New Character</span>
                </button>
            </div>
