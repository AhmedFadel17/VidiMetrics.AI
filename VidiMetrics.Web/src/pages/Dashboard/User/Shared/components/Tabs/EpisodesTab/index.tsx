...
import { useGetEpisodesByShowQuery } from "@/store/apis";
...
export default function EpisodesTab({ showId }: EpisodesTabProps) {
    ...
    const { data: response, isLoading, error } = useGetEpisodesByShowQuery(showId);
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <button className="glass-card px-6 py-2 rounded-full flex items-center gap-2 hover:bg-white/10">
                    ...
                    <span className="text-xs font-bold text-white uppercase tracking-widest">New Episode</span>
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <button className="border-[1.5px] border-dashed border-white/10 rounded-[2rem] bg-white/[0.02] hover:bg-white/[0.04] hover:border-accent-cyan/40 transition-all duration-500 group flex flex-col items-center justify-center p-8 text-center min-h-[280px]">
                    ...
                    <h4 className="text-lg font-bold text-white mb-2">Generate New Episode</h4>
