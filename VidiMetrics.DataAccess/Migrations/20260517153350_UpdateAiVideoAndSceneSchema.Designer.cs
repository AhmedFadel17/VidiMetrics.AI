...
namespace VidiMetrics.DataAccess.Migrations
{
    ...
    [Migration("20260517153350_UpdateAiVideoAndSceneSchema")]
    partial class UpdateAiVideoAndSceneSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VidiMetrics.Domain.Models.StoryEngine.Episode", b =>
                {
                    ...
                    b.HasOne("VidiMetrics.Domain.Models.Ai.AiImage", "ThumbnailImage")
                        .WithMany()
