...
public class CharactersController : ApiBaseController
{
    ...
    [HttpGet]
    public async Task<ActionResult<SuccessResponseDto<PaginationResponseDto<CharacterResponseDto>>>> GetAll(
        [FromQuery] CharacterFilterDto filter,
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<SuccessResponseDto<CharacterResponseDto>>> GetById(Guid id, CancellationToken ct)
    {
